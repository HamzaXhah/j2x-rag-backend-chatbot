...
async def suggest_questions(
    ...
    """Create clickable investor questions grounded in indexed documents."""
    try:
        questions = rag_generator.generate_suggested_questions(
        ...
        raise HTTPException(
            status_code=500,
            detail=f"Error generating suggested questions: {exc}",
        ) from exc
